...
public partial class Admin_AddResto : System.Web.UI.Page
{
    ...
    protected void Button8_Click(object sender, EventArgs e)
    {
        ...
        if (uploadimage() == true)
        {
            ...
            cmd.CommandText = "insert into Restaurant values('" + TextBox1.Text + "','" + imagelink + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + DropDownList2.SelectedItem.Value + "','"+ TextBox4.Text+"')";
            cmd.ExecuteNonQuery();
            con.Close();
            ...
            Label12.Text = "Restaurant Has Been Successfully Saved";
            getproductid();
            TextBox1.Text = "";
            TextBox2.Text = "";
        }
    ...
    private Boolean uploadimage()
    {
        ...
        if (FileUpload1.HasFile == true)
        {
            ...
            if (contenttype == "image/jpeg")
            {
                ...
                FileUpload1.SaveAs(Server.MapPath("~/Admin/imgrest/" + Label3.Text + ".jpg"));
                imagelink = "Admin/imgrest/" + Label3.Text + ".jpg";
                imagesaved = true;
            }
            else
            {
    ...
    public void getproductid()
    {
        ...
        String myquery = "select RID from Restaurant";
        ...
        else
        {
            ...
            String myquery1 = "select max(RID) from Restaurant";
